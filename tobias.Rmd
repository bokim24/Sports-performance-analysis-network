...
Tobias' careerlog was interesting enough that it made me have to utilize other workarounds like I did with midseason trades.

The whole formation of the code looks much different, and more advanced even (at least I like to think), since I'm ultimately creating one large dataframe and using group by to make frame animamtions by year. Big thing to note here is that
the entire dataframe has to be in numerical format so that plotly can read it more fluidly and create better looking graphs.
